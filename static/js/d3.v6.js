...
(function (global, factory) {
  ...
  function bin() {
    ...
    histogram.domain = function (_) {
      return arguments.length
        ? ((domain = typeof _ === "function" ? _ : constant$b([_[0], _[1]])), histogram)
        : domain;
    };
  ...
  function selection_text(value) {
    return arguments.length
      ? this.each(
          value == null
            ? textRemove
            : (typeof value === "function" ? textFunction$1 : textConstant$1)(value)
        )
  ...
  class Path {
    ...
    arc(x, y, r) {
      ...
      if (this._x1 === null) this._ += `M${x0},${y0}`;
        ...
        this._ += "L" + x0 + "," + y0;
      if (!r) return;
      this._ += `A${r},${r},0,1,1,${x - r},${y}A${r},${r},0,1,1,${(this._x1 = x0)},${(this._y1 =
        y0)}`;
    }
    rect(x, y, w, h) {
  ...
  function parser(type) {
    return (input, init) =>
      text(input, init).then((text) => new DOMParser().parseFromString(text, type));
  }
  ...
  function collide(radius) {
    ...
    force.radius = function (_) {
      return arguments.length
        ? ((radius = typeof _ === "function" ? _ : constant$4(+_)), initialize(), force)
        : radius;
    };
  ...
  function x$1(x) {
    ...
    force.x = function (_) {
      return arguments.length
        ? ((x = typeof _ === "function" ? _ : constant$4(+_)), initialize(), force)
        : x;
    };
  ...
  function y$1(y) {
    ...
    force.y = function (_) {
      return arguments.length
        ? ((y = typeof _ === "function" ? _ : constant$4(+_)), initialize(), force)
        : y;
    };
  ...
  function centroidLinePoint(lambda, phi) {
    ...
    var cosPhi = cos$1(phi),
      ...
      w = atan2$1(
        sqrt$2(
          (w = y0$4 * z - z0 * y) * w + (w = z0 * x - x0$4 * z) * w + (w = x0$4 * y - y0$4 * x) * w
        ),
        x0$4 * x + y0$4 * y + z0 * z
      );
    W1 += w;
  ...
  function circle$2() {
    ...
    circle.center = function (_) {
      return arguments.length
        ? ((center = typeof _ === "function" ? _ : constant$3([+_[0], +_[1]])), circle)
        : center;
    };
    ...
    function resampleLineTo(
      ...
      if (d2 > 4 * delta2 && depth--) {
        var a = a0 + a1,
          ...
          phi2 = asin$1((c /= m)),
          lambda2 =
            abs$1(abs$1(c) - 1) < epsilon$1 || abs$1(lambda0 - lambda1) < epsilon$1
              ? (lambda0 + lambda1) / 2
              : atan2$1(b, a),
  ...
  function index() {
    ...
    treemap.paddingBottom = function (x) {
      return arguments.length
        ? ((paddingBottom = typeof x === "function" ? x : constant$2(+x)), treemap)
        : paddingBottom;
    };
    ...
    function arc() {
      ...
      // Or is it a circular or annular sector?
        ...
        var a01 = a0,
          ...
          rp =
            ap > epsilon &&
            (padRadius ? +padRadius.apply(this, arguments) : sqrt(r0 * r0 + r1 * r1)),
  ...
  function stack() {
    ...
    stack.order = function (_) {
      return arguments.length
        ? ((order = _ == null ? none : typeof _ === "function" ? _ : constant$1(Array.from(_))),
          stack)
        : order;
    };
